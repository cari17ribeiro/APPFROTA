                      ...
                      <tr key={viagem.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="p-4 text-center">
                          {viagem.ocr_correto === true ? (
                            <span className="inline-flex items-center px-2 py-1 bg-emerald-100 text-emerald-700 rounded-md text-xs font-bold">
                              <CheckCircle className="w-3 h-3 mr-1" /> Acerto
                            </span>
                          ) : viagem.ocr_correto === false ? (
                            <span className="inline-flex items-center px-2 py-1 bg-rose-100 text-rose-700 rounded-md text-xs font-bold">
                              <AlertCircle className="w-3 h-3 mr-1" /> Ajustado
                            </span>
                          ) : (
                            <span className="inline-flex items-center px-2 py-1 bg-slate-100 text-slate-500 rounded-md text-xs font-bold">
                              Não avaliado
                            </span>
                          )}
                        </td>
                        <td className="p-4 text-right">
                          {viagem.comprovante_url ? (
                            <button
                              onClick={() => setFotoHistoricoModal(viagem)}
        ...
        <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm flex items-center justify-center z-[110] p-4" onClick={() => setFotoHistoricoModal(null)}>
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-4xl max-h-[92vh] flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
            <div className="bg-slate-50 border-b border-slate-200 px-6 py-4 flex justify-between items-center">
              <div>
                <h3 className="text-lg font-black text-slate-800">Foto do Histórico</h3>
            ...
            <div className="bg-slate-900 flex-1 min-h-[420px] p-4 flex items-center justify-center overflow-auto">
              <a href={fotoHistoricoModal.comprovante_url} target="_blank" rel="noreferrer" className="w-full h-full flex items-center justify-center">
                <img
                  src={fotoHistoricoModal.comprovante_url}
                  alt="Comprovante do histórico"
          ...
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-5xl flex flex-col overflow-hidden max-h-[90vh]">
              ...
              <form id="form-validacao" onSubmit={aprovarViagem} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 h-fit space-y-5">
                  <div className="bg-blue-50 text-blue-800 p-4 rounded-xl text-sm font-medium border border-blue-100 mb-6">
                    Revise os dados lidos pela IA. Se algum campo estiver vazio ou incorreto, edite-o olhando para a foto antes de aprovar.
                  </div>
                  ...
                  <div className="pt-4 border-t border-slate-200 grid grid-cols-2 gap-2 text-sm text-slate-500">
                    <div>
                      <strong className="block text-xs uppercase">Operação:</strong>
                      {viagemSelecionada.tipo_operacao}
                    </div>
                    <div>
                      <strong className="block text-xs uppercase">Trajeto:</strong>
            ...
            <div className="bg-white border-t border-slate-200 px-6 py-4 flex flex-col sm:flex-row justify-between gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button type="button" onClick={fecharModal} disabled={isSaving} className="px-6 py-3 text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl font-bold transition-colors disabled:opacity-50">
                  Cancelar
                </button>
